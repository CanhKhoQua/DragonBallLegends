...
public final class MobMe extends Mob {
    ...
    public void spawn() {
        ...
        try {
            ...
            msg.writer().writeInt((int) Util.maxIntValue(this.point.hp));// hp mob
            Service.gI().sendMessAllPlayerInMap(this.player, msg);
            msg.cleanup();
        } catch (Exception e) {
        }
    ...
    public synchronized void injured(Player plAtt, long damage, boolean dieWhenHpFull) {
        ...
        try {
            ...
            msg.writer().writeInt((int) Util.maxIntValue(point.hp));
            Service.gI().sendMessAllPlayerInMap(this.player, msg);
            msg.cleanup();
            if (isDie()) {
                mobMeDie();
