...
public class DanhBongSaoPhaLe {
    ...
    public static void danhBongSaoPhaLe(Player player) {
        ...
        if (Util.isTrue(30, 100)) {
            ...
            int tempId = saoPhaLeC2.template.id + 10;
            saoPhaLeLapLanh.template = ItemService.gI().getTemplate(tempId);
            saoPhaLeLapLanh.itemOptions.clear();
            saoPhaLeLapLanh.itemOptions.add(saoPhaLeLapLanh.getOptionDaPhaLe());
            saoPhaLeLapLanh.itemOptions.add(new Item.ItemOption(87, 0));
