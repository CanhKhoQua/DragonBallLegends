...
//                return 450000000;
    ...
    private static boolean isCoupleItemNangCapCheck3(Item trangBi, Item daNangCap) {
        if (trangBi != null && daNangCap != null) {
            if ((trangBi.template.id >= 529 && trangBi.template.id <= 531 || trangBi.template.id >= 534 && trangBi.template.id <= 536 || trangBi.template.id == 1751) && daNangCap.template.id == 1710) {
                return true;
            }
        } else {
            return false;
