...
public class NangChiSoBongTai {
    ...
    private static final int COST_RUBY = 750;
    ...
    public static void showInfoCombine(Player player) {
        ...
        text.append(ConstFont.BOLD_BLUE).append("Tỉ lệ thành công: 80%\n");
    ...
    public static void nangChiSoBongTai(Player player) {
        ...
        if (bongTai == null || manhHonBongTai == null || daXanhLam == null || player.inventory.ruby < COST_RUBY || daXanhLam.quantity < 1 || manhHonBongTai.quantity < 99) {
            return;
        }
