...
import models.Combine.manifest.VinhVienCaiTrang;
...
public class CombineService {
    ...
    public static final int VINH_VIEN_CAI_TRANG = 999;
    ...
    public void showInfoCombine(Player player, int[] index) {
        ...
        switch (player.combine.typeCombine) {
            ...
            case VINH_VIEN_CAI_TRANG ->
                VinhVienCaiTrang.showInfoCombine(player);
    ...
    public void startCombine(Player player, int... n) {
        ...
        switch (player.combine.typeCombine) {
            ...
            case VINH_VIEN_CAI_TRANG ->
                VinhVienCaiTrang.startCombine(player);
        }
...
//            msg.writer().writeShort(-1); // y
    ...
    public void sendAddItemCombine(Player player, int npcId, Item... items) {
        ...
        try {
            msg = new Message(-81);
            msg.writer().writeByte(0);
            msg.writer().writeUTF("By CanhKhoQua");
            msg.writer().writeUTF("Dragon Ball Legends");
    ...
    private String getTextTopTabCombine(int type) {
        return switch (type) {
            ...
            case NANG_CAP_KICH_HOAT_VIP ->
                "Ta sẽ phù phép\nbiến đồ Thần Linh\nthành trang bị Kích Hoạt ngẫu nhiên";
            case GIA_HAN_VAT_PHAM ->
                "Ta sẽ phù phép\ncho trang bị của ngươi\nthêm hạn sử dụng";
            case SIEU_HOA ->
    ...
    private String getTextInfoTabCombine(int type) {
        return switch (type) {
            ...
            case TAO_DA_HEMATITE ->
                "Vào hành trang\nChọn 3 sao pha lê cấp 2 cùng màu\nChọn 'Tạo đá Hematite'";
            case GIAM_DINH_SACH ->
            ...
            case NANG_CAP_KICH_HOAT_VIP ->
                "Vào hành trang\nChọn 1 đồ Thần Linh\nChọn Đá ngũ sắc số lượng 15\nCần thêm 100 triệu vàng\n90% ra Kích Hoạt thường\n10% ra Kích Hoạt Thần Linh\nSau đó chọn 'Nâng cấp'";
            case DAP_DO_AO_HOA ->
                "vào hành trang\nChọn trang bị\n(Áo, quần, găng, giày hoặc rađa)"
            ...
            case VINH_VIEN_CAI_TRANG ->
                "Vào hành trang\n"
                + "Chọn 1 cải trang có hạn sử dụng\n"
                + "Chọn Đá ngũ sắc\n"
                + "Sau đó chọn 'Làm phép'";
            default ->
                "";
