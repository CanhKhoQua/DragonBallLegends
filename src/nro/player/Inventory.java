...
public class Inventory {
    ...
    public static final byte TYPE_COSTUME_BOX = 2;
    public static final int PRICE_SLOT_COLLECTION_BOX = 1_500_000_000;
    public static final byte MAX_ITEM_BOX_COLLECTION = 80;
    public static final int MAX_ITEM_COSTUME_BOX = 100;
    ...
    public List<Item> itemsCostumeBox;
    ...
    public void dispose() {
        ...
        if (this.itemsCostumeBox != null) {
            this.itemsCostumeBox.forEach(Item::dispose);
            this.itemsCostumeBox.clear();
        }
        this.itemsBody = null;
        this.itemsBag = null;
        this.itemsBox = null;
