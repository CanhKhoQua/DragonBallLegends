...
public class MySession extends Session {
    ...
    public MySession(Socket socket) {
        ...
        this.lastTimeReadMessage = System.currentTimeMillis();
    }
    ...
    public void login(String username, String password) {
        ...
        try {
                    ...
                    if (pl != null) {
                        try {
                            DBConnecter.executeUpdate(
                                "UPDATE account SET last_login_ip = ? WHERE username = ?",
                                this.ipAddress, this.uu);
                        ...
                        Client.gI().registerSession(this);
                        ServerManager.gI().onLoginSuccess(this);
            ...
            this.logging = !this.loginSuccess;
            if (!this.loginSuccess && this.player == null) {
                this.uu = null;
                this.pp = null;
            }
        }
