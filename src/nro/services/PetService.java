...
public class PetService {
    ...
    public void changeUubPet(Player player) {
        ...
        resetOldPet(player);
        createPetThread(player, false, true, false, false, gender, "Xin hãy thu nhận con làm đệ tử", limitPower);
    }
    ...
    public void changeKidBeerPet(Player player) {
        ...
        byte gender = player.pet.gender;
        resetOldPet(player);
        createPetThread(player, false, false, true, false, gender, "Hãy hợp tác với ta, Kakarot!", limitPower);
    }
    ...
    public void changeJirenPet(Player player) {
        ...
        byte gender = player.pet.gender;
        resetOldPet(player);
        createPetThread(player, false, false, false, true, gender, "Xin hãy thu nhận con làm đệ tử", limitPower);
    }
