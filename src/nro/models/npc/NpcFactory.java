    ...
    public static Npc createNPC(int mapId, int status, int cx, int cy, int tempId) {
        ...
        try {
            return switch (tempId) {
                ...
                case ConstNpc.NHA_TAO_MAU -> new NhaTaoMau(mapId, status, cx, cy, tempId, avatar);
                ...
                switch (player.iDMark.getIndexMenu()) {
                    ...
                    case ConstNpc.SET_TLTD, ConstNpc.SET_VAI_THO_TD -> {
                        switch (select) {
                            ...
                            case 3 -> ItemService.gI().settlkaioken(player);
                            case 4 -> ItemService.gI().settlthanvutrukaio(player);
                        }
                    }
                    case ConstNpc.SET_TLNM, ConstNpc.SET_VAI_THO_NM -> {
                        switch (select) {
                            ...
                            case 2 -> ItemService.gI().settllienhoan(player);
                            case 3 -> ItemService.gI().settlpiko(player);
                            case 4 -> ItemService.gI().settlnail(player);
                        }
                    }
                    case ConstNpc.SET_TLXD, ConstNpc.SET_VAI_THO_XD -> {
                        switch (select) {
                            ...
                            case 3 -> ItemService.gI().settlcadicm(player);
                        }
                    }
                    case ConstNpc.SET_HDTD -> {
                        switch (select) {
                            ...
                            case 3 -> ItemService.gI().sethdkaioken(player);
                            case 4 -> ItemService.gI().sethdthanvutrukaio(player);
                        }
                    }
                    case ConstNpc.SET_HDNM -> {
                        switch (select) {
                            ...
                            case 2 -> ItemService.gI().sethdlienhoan(player);
                            case 3 -> ItemService.gI().sethdpiko(player);
                            case 4 -> ItemService.gI().sethdnail(player);
                        }
                    }
                    case ConstNpc.SET_HDXD -> {
                        switch (select) {
                            ...
                            case 3 -> ItemService.gI().sethdcadicm(player);
                        }
                    }
                    case ConstNpc.IGNORE_MENU -> {
                    }
