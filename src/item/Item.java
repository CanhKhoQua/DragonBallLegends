...
public class Item {
    ...
    public boolean isDaPhaLeC2() {
        return template != null && template.id >= 1416 && template.id <= 1422;
    }

    public boolean isDaPhaLeMoi() {
        return template != null && ((template.id >= 1416 && template.id <= 1422)
                || (template.id >= 1426 && template.id <= 1432));
    }
    ...
    public ItemOption getOptionDaPhaLe() {
        return switch (template.id) {
            ...
            case 1416 ->
                new ItemOption(95, 10);
            case 1417 ->
                new ItemOption(96, 10);
            case 1418 ->
                new ItemOption(97, 10);
            case 1419 ->
                new ItemOption(98, 10);
            case 1420 ->
                new ItemOption(99, 10);
            case 1421 ->
                new ItemOption(100, 10);
            case 1422 ->
                new ItemOption(101, 10);

            case 1426 ->
                new ItemOption(95, 15);
            case 1427 ->
                new ItemOption(96, 15);
            case 1428 ->
                new ItemOption(97, 15);
            case 1429 ->
                new ItemOption(98, 15);
            case 1430 ->
                new ItemOption(99, 15);
            case 1431 ->
                new ItemOption(100, 15);
            case 1432 ->
                new ItemOption(101, 15);
            default ->
                itemOptions.get(0);
        };
    }
